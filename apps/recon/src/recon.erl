...
-type binding() :: recon_syntax:binding().
-type command() :: recon_syntax:command().
-type context() :: recon_syntax:context().
-type info()    :: recon_syntax:info().

-define(core,   recon_core).
-define(lexer,  recon_lexer).
-define(parser, recon_parser).
